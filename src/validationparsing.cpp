...
const std::map<std::string, bool> ValidatorFileSystem::_boolean_expressions = {
        {"0",     false},
        {"1",     true},
        {"f",     false},
        {"t",     true},
 ...
 */
bool ValidatorFileSystem::validateFilePath(std::string filePath, bool executable = false)
{
    if (filePath.empty())
        return false;
